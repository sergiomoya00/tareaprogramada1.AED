...
public class CrearSorteo extends javax.swing.JFrame {
    // Se crean los atributos de tipo Raffle,Loteria,Lotto,Bingo,Tiempos para instancear objetos
    ...
    // Se crea el respectivo método get, para cada atributo
    ...
    this.raffle= new Raffle(); // Se realizan los sets en la clase Raffle
    ...
    if (comboraffle.getSelectedIndex()==0){ // Utilizamos este if para insertar en la clase Loteria
    ...
    if (comboraffle.getSelectedIndex()==1){ // Utilizamos este if para insertar en la clase Lotto
    ...
    if (comboraffle.getSelectedIndex()==2){// Utilizamos este if para insertar en la clase Bingo
    ...
    if (comboraffle.getSelectedIndex()==3){ // Utilizamos este if para insertar en la clase Tiempos
    ...
    LotteryManager.getInstance().addRaffle(raffle); // Se inserta objeto en la lista Raffle
